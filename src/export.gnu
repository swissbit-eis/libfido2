{
	global:
		...
		fido_blob_set;
		fido_blob_free;
		fido_build_assert_cbor;
		fido_build_cred_cbor;
		...
		fido_dev_get_transport_functions;
		fido_dev_io_handle;
		fido_dev_is_fido2;
		...
		fido_init;
		fido_parse_and_add_get_next_assert_msg;
		cbor_add_uv_params;
		cbor_add_uv_params_assert;
		cbor_build_frame_ext;
		cbor_parse_reply;
		decrypt_hmac_secrets;
		decrypt_uv_token;
		es256_pk_encode;
		fido_parse_get_assert_msg;
		fido_parse_make_cred_msg;
		fido_do_ecdh_ext;
